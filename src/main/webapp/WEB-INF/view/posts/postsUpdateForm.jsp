...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$(".deleteAtta").on("click", function(){
			...
			attafile_arr += attafile + ",";
			
			console.log(attafile_arr);
			$("#attafile_arr").val(attafile_arr);
...
<form action="/posts/postsUpdate" method="post" id="frm"
	...
	<input type="hidden" id="attafile_arr" name="attafile_arr">
